...
<?php
    ...
    class Prod
    {
        ...
        function __construct()
        {
            ...
            $this->photo = "";
            $this->ref = "";
            //le champ cat_id est mis à 0 pour que le champ par défaut du Select soit sélectionné au chargement de la page
            $this->cat_id = "0";
            $this->libelle = "";
...
<form action="add_script.php" method="POST" enctype="multipart/form-data" class="was-validated" id="theform" validate>
        ...
        <select class="form-control" name="cat" id="cat" required>
            ...
            ?>
                    <option 
                        ...
                        ////Au chargement de ce formulaire, la case par défaut sera toujours sélectionné, si tout va bien ;)
    ...
    <div class="form-group">
        <button type="reset" class="btn btn-info">
            <i class="fa fa-fw fa-undo"></i> Réinitialiser le formulaire
        </button>
    </div>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-success">
            <i class="fa fa-fw fa-plus-circle"></i> Ajouter
        </button>
    </div>
