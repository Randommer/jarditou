...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" id="contact" name="contact" novalidate>
    <p>* Ces zones sont oligatoires</p>
    <h1>Vos coordonnées</h1>
    <!-- Champ pour le nom -->
    <div class="form-group">
        <label for="nom">Nom*</label>
        <input type="text" class="form-control <?php if ($nomval != -1) { if ($nomval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="nom" id="nom" placeholder="Veuillez saisir votre nom" required <?php echo "value='".$nom."'"; ?>>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control <?php if ($prenomval != -1) { if ($prenomval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="prenom" id="prenom" placeholder="Veuillez saisir votre prénom" required <?php echo "value='".$prenom."'"; ?>>
    ...
    <div class="form-group">
        ...
        <br>
            <div class="form-check-inline">
                <input class="form-check-input <?php if ($sexeval != -1) { if ($sexeval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" type="radio" name="sexe" id="feminin" value="feminin" required <?php if ($fem) { echo "checked"; } ?>>
                <label class="form-check-label" for="feminin"> Féminin</label>
            </div>
            <div class="form-check-inline">
                <input class="form-check-input <?php if ($sexeval != -1) { if ($sexeval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" type="radio" name="sexe" id="masculin" value="masculin" required <?php if ($mas) { echo "checked"; } ?>>
                <label class="form-check-label" for="masculin"> Masculin</label>
            </div>
            <div class="form-check-inline">
                <input class="form-check-input <?php if ($sexeval != -1) { if ($sexeval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" type="radio" name="sexe" id="neutre" value="neutre" required <?php if ($neu) { echo "checked"; } ?>>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="date" class="form-control <?php if ($naissanceval != -1) { if ($naissanceval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="naissance" id="naissance" required <?php if ($naissanceval > -1) { echo "value=".date_format($naissance, "Y-m-d"); } ?>>
            ...
            <div class="invalid-feedback" id="naissance-invalid">Selectionnez une date<?php if ($naissanceval == 0) { echo " passée"; } ?>.</div>
        </div>
    </div>
    <!-- Champ pour le code postal -->
    <div class="form-group">
        <label for="CP">Code Postal*</label>
        <input type="text" class="form-control <?php if ($CPval != -1) { if ($CPval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="CP" id="CP" required <?php echo "value='".$CP."'"; ?>>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="adresse" id="adresse" <?php echo "value='".$adresse."'"; ?>>
    </div>
    <!-- Champ pour la ville -->
    <div class="form-group">
        <label for="ville">Ville</label>
        <input type="text" class="form-control" name="ville" id="ville" <?php echo "value='".$ville."'"; ?>>
    </div>
    <!-- Champ pour le mail -->
    <div class="form-group">
        <label for="email">Email*</label>
        <input type="email" class="form-control <?php if ($emailval != -1) { if ($emailval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="email" id="email" placeholder="dave.loper@afpa.fr" pattern="[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([_\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})" required <?php echo "value='".$email."'"; ?>>
    ...
    <div class="form-group">
        ...
        <select class="form-control <?php if ($sujetval != -1) { if ($sujetval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="sujet" id="sujet" required>
            <option value="" disabled <?php if ($sj1) { echo "selected"; } ?>>Veuillez sélectionner un sujet</option>
            <option value="commandes" <?php if ($sj2) { echo "selected"; } ?>>Mes commandes</option>
            <option value="question" <?php if ($sj3) { echo "selected"; } ?>>Question sur un produit</option>
            <option value="reclamation" <?php if ($sj4) { echo "selected"; } ?>>Réclamation</option>
            <option value="autres" <?php if ($sj5) { echo "selected"; } ?>>Autres</option>
        </select>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control <?php if ($questionval != -1) { if ($questionval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" name="question" id="question" rows="2" required><?php echo $question; ?></textarea>
    ...
    <div class="form-group form-check">
        <input class="form-check-input <?php if ($acceptedval != -1) { if ($acceptedval == 1) { echo "is-valid"; }else{ echo "is-invalid"; } } ?>" type="checkbox" name="accepted" id="accepted" value=true required <?php if ($accepted) { echo "checked"; } ?>>
